    ...
    <div class="container">
        ...
        <div class="definition my-xl-5 my-4">
            ...
            <p class="wow animate__animated animate__fadeInUp">
                ...
                partitioned
                into multiple virtual interfaces. This allows you to use the same connection to access public resources
                such
                as
                objects stored in Amazon S3 using public IP address space, and private resources such as Amazon EC2
                instances
                running within an Amazon Virtual Private Cloud (VPC) using private IP space, while maintaining network
                separation between the public and private environments. Virtual interfaces can be reconfigured at any
                time
                to
        ...
        <div class="benefits my-xl-5 my-4">
            ...
            <div class="row">
                <div class="col-lg-4 col-sm-6">
                    <div class="text-center mt-4 wow animate__animated animate__fadeInUp">
                        ...
                        <p class="benefits-content-detail">
                            If you have bandwidth-heavy workloads that you wish to run in AWS, AWS Direct Connect
                            reduces
                            your
                            network costs into and out of AWS in two ways. First, by transferring data to and from AWS
                            directly,
                            you can reduce your bandwidth commitment to your Internet service provider. Second, all data
                            transferred over your dedicated connection is charged at the reduced AWS Direct Connect data
                            transfer rate rather than Internet data transfer rates.
                        </p>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6">
                    <div class="text-center mt-4 wow animate__animated animate__fadeInUp">
                        ...
                        <p class="benefits-content-detail">
                            Network latency over the Internet can vary given that the Internet is constantly changing
                            how
                            data
                            gets from point A to
                            B. With AWS Direct Connect, you choose the data that utilizes the dedicated connection and
                            how
                            that
                            data is routed which
                            can provide a more consistent network experience over Internet-based connections.
                        </p>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6">
                    <div class="text-center mt-4 wow animate__animated animate__fadeInUp">
                        ...
                        <p class="benefits-content-detail">
                            AWS Direct Connect is a network service, and works with all AWS services that are accessible
                            over
                            the Internet, such as
                            Amazon Simple Storage Service (Amazon S3), Elastic Compute Cloud (Amazon EC2), and Amazon
                            Virtual
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="text-center mt-4 wow animate__animated animate__fadeInUp">
                        ...
                        <p class="benefits-content-detail">
                            You can use AWS Direct Connect to establish a private virtual interface from your on-premise
                            network directly to your
                            Amazon VPC, providing you with a private, high bandwidth network connection between your
                            network
                            and your VPC. With
                            multiple virtual interfaces, you can even establish private connectivity to multiple VPCs
                            while
                            maintaining network
                            isolation.
                        </p>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="text-center mt-4 wow animate__animated animate__fadeInUp">
                        ...
                        <p class="benefits-content-detail">
                            AWS Direct Connect makes it easy to scale your connection to meet your needs. AWS Direct
                            Connect
                            provides 1
                            Gbps and 10
                            Gbps connections, and you can easily provision multiple connections if you need more
                            capacity.
                            You can also
                            use AWS
                            Direct Connect instead of establishing a VPN connection over the Internet to your Amazon
                            VPC,
                            avoiding the
                            need to
                            utilize VPN hardware that frequently can’t support data transfer rates above 4 Gbps.
                        </p>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6">
                    <div class="text-center mt-4 wow animate__animated animate__fadeInUp">
                        ...
                        <p class="benefits-content-detail">
                            You can sign up for AWS Direct Connect service quickly and easily using the AWS Management
                            Console. The console provides
                            a single view to efficiently manage all your connections and virtual interfaces. You can
                            also
                            download customized router
                            templates for your networking equipment after configuring one or more virtual interfaces.
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="customers-items">
                    <div class="customers-item mt-4">
                        ...
                        <div class="customers-item-content wow animate__animated animate__fadeInUp">
                            ...
                            service
                            are excellent,
                            maximizing the customer experience. In the past, if only using the Internet, it was easy to
                            crash
                            the system, the number
                            of transactions was congested, making the order processing overload."
                        </div>
                    </div>
                    <div class="customers-item mt-4">
                        <div class="customers-item-header wow animate__animated animate__fadeInUp">
                        ...
                        <div class="customers-item-content wow animate__animated animate__fadeInUp">
                            ...
                            making
                            AWS Direct Connect
                            service more secure and highly available. From there, we can confidently bring high-quality
            ...
            <div class="how-it-works my-xl-5 my-4">
                ...
                <ul class="wow animate__animated animate__fadeInUp">
                    ...
                    <li>Only 1 virtual Interface allowed per hosted connection.</li>
                </ul>
            </div>
            <div class="my-xl-5 my-4">
                ...
                <div class="wow animate__animated animate__fadeInUp">
                    ...
                    <ul>
                        ...
                        <li>Set up DC and DR at two different places.</li>
