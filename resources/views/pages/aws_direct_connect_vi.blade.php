    ...
    <div class="container">
        <div class="text-center my-xl-5 my-4 wow animate__animated animate__fadeInUp">
            ...
            <div class="d-lg-none d-block">
                <img src="/images/aws-direct-connect/amazon-web-services.jpg" alt="" class="img-fluid w-75">
            </div>
        </div>
        <div class="definition my-xl-5 my-4">
            ...
            <p class="wow animate__animated animate__fadeInUp">
                ...
                tâm dữ liệu, văn
                phòng hoặc môi trường cho thuê chỗ đặt máy chủ, mà trong nhiều trường hợp có thể giúp giảm chi phí mạng,
                tăng lưu lượng
            ...
            <p class="wow animate__animated animate__fadeInUp">
                ...
                giao diện ảo.
                Điều này cho phép bạn sử dụng cùng kết nối để truy cập các tài nguyên công cộng như các đối tượng được
                lưu trên Amazon
                S3 sử dụng không gian địa chỉ IP công khai và các tài nguyên riêng như các phiên bản Amazon EC2 đang
                chạy trong Amazon
                Virtual Private Cloud (VPC) sử dụng không gian IP riêng, đồng thời duy trì sự tách biệt mạng giữa môi
                trường công khai
                và môi trường riêng. Các giao diện ảo có thể được cấu hình vào bất kỳ thời điểm nào để đáp ứng các nhu
                cầu thay đổi liên
                tục của bạn.
            </p>
        </div>
        <div class="benefits my-xl-5 my-4">
            ...
            <div class="row">
                <div class="col-lg-4 col-sm-6">
                    <div class="text-center mt-4 wow animate__animated animate__fadeInUp">
                        ...
                        <p class="benefits-content-detail">
                            Nếu bạn có khối lượng công việc sử dụng băng thông lớn muốn chạy trên AWS, AWS Direct
                            Connect sẽ giảm chi phí mạng vào
                            và ra khỏi AWS cho bạn theo hai cách. Thứ nhất, bằng cách truyền dữ liệu trực tiếp đến và đi
                            từ AWS, bạn có thể giảm phí
                            cam kết băng thông với nhà cung cấp dịch vụ Internet. Thứ hai, toàn bộ dữ liệu truyền qua
                            kết nối chuyên biệt của bạn
                            được tính phí theo tốc độ truyền dữ liệu của AWS Direct Connect đã được giảm đi thay vì tốc
                            độ truyền dữ liệu Internet.
                        </p>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6">
                    <div class="text-center mt-4 wow animate__animated animate__fadeInUp">
                        ...
                        <p class="benefits-content-detail">
                            Độ trễ mạng qua Internet có thể thay đổi do Internet liên tục thay đổi cách thức truyền dữ
                            liệu từ điểm A sang B. Với
                            AWS Direct Connect, bạn có thể chọn dữ liệu sử dụng kết nối chuyên biệt và cách thức định
                            tuyến dữ liệu có thể mang đến
                            trải nghiệm mạng nhất quán hơn qua kết nối dựa trên Internet.
                        </p>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6">
                    <div class="text-center mt-4 wow animate__animated animate__fadeInUp">
                        ...
                        <p class="benefits-content-detail">
                            AWS Direct Connect là dịch vụ mạng và hoạt động với tất cả các dịch vụ AWS có thể truy cập
                            qua Internet, chẳng hạn như
                            Amazon Simple Storage Service (Amazon S3), Elastic Compute Cloud (Amazon EC2) và Amazon
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="text-center mt-4 wow animate__animated animate__fadeInUp">
                        ...
                        <p class="benefits-content-detail">
                            Bạn có thể sử dụng AWS Direct Connect để thiết lập giao diện ảo riêng từ mạng tại chỗ đến
                            Amazon VPC của bạn, từ đó mang
                            đến cho bạn kết nối mạng riêng, băng thông cao giữa mạng và VPC của bạn. Với nhiều giao diện
                            ảo, bạn thậm chí còn có thể
                            thiết lập kết nối riêng tới nhiều VPC mà vẫn duy trì được phân lập mạng.
                        </p>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6">
                    <div class="text-center mt-4 wow animate__animated animate__fadeInUp">
                        ...
                        <p class="benefits-content-detail">
                            AWS Direct Connect giúp bạn dễ dàng thay đổi quy mô kết nối để đáp ứng nhu cầu của mình. AWS
                            Direct Connect cung cấp kết
                            nối 1 Gbps và 10 Gbps và bạn có thể dễ dàng cung cấp nhiều kết nối nếu bạn cần thêm dung
                            lượng. Bạn còn có thể sử dụng
                            AWS Direct Connect thay vì thiết lập kết nối VPN qua Internet đến Amazon VPC của bạn, giúp
                            tránh phải sử dụng phần cứng
                            VPN thường không thể hỗ trợ tốc độ truyền dữ liệu cao hơn 4 Gbps.
                        </p>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6">
                    <div class="text-center mt-4 wow animate__animated animate__fadeInUp">
                        ...
                        <p class="benefits-content-detail">
                            Bạn có thể đăng ký dịch vụ AWS Direct Connect nhanh chóng và dễ dàng qua Bảng điều khiển
                            quản lý AWS. Bảng điều khiển
                            cung cấp dạng hiển thị đơn nhất để quản lý hiệu quả tất cả các kết nối và giao diện ảo của
                            bạn. Bạn cũng có thể tải
                            xuống các mẫu bộ định tuyến đã tùy chỉnh cho thiết bị mạng của mình sau khi cấu hình một
                            hoặc nhiều giao diện ảo.
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="customers-items">
                    <div class="customers-item mt-4">
                        ...
                        <div class="customers-item-content wow animate__animated animate__fadeInUp">
                            ...
                            thống số số lượng transaction
                            bị dồn ứ khiến cho việc xử lý đơn hàng quá tải"
                        </div>
                    </div>
                    <div class="customers-item mt-4">
                        <div class="customers-item-header wow animate__animated animate__fadeInUp">
                        ...
                        <div class="customers-item-content wow animate__animated animate__fadeInUp">
                            ...
                            nghiệm sử dụng dịch vụ cao
                            cấp cho các khách hàng Fintech của VPBank"
                        </div>
                    </div>
                </div>
            </div>
            <div class="how-it-works my-xl-5 my-4">
                ...
                <ul class="wow animate__animated animate__fadeInUp">
                    ...
                    <li>Chỉ cho phép 01 virtual Interface trên mỗi hosted connection. </li>
                </ul>
            </div>
            <div class="my-xl-5 my-4">
                ...
                <div class="wow animate__animated animate__fadeInUp">
                    ...
                    <ul>
                        ...
                        <li>Thiết lập DC và DR tại hai nơi khác nhau.</li>
