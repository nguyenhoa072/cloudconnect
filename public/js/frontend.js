  ...
  init: function init() {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).scroll(function () {
      if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).scrollTop() > 100) {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(".scroll-top").fadeOut();
      }
    }); // Click event to scroll to top

    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".scroll-top").click(function () {
...
var initMap = {
  init: function init() {
    ...
    if (contact_map) {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_0___default()("#listMapID li").each(function () {
        var position = {
          lat: Number(jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).attr("data-map-lat")),
          lng: Number(jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).attr("data-map-lng"))
        };
        var title = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).find(".name").html();
      ...
      jquery__WEBPACK_IMPORTED_MODULE_0___default()("#listMapID li").on("click", function () {
        var latLng = {
          lat: Number(jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).attr("data-map-lat")),
          lng: Number(jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).attr("data-map-lng"))
        };
